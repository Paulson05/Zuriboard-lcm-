<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
    <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="nav navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link" href="{{route('generalposts.index') }}"><i class="far fa-user-circle"></i><span>GeneralPosts</span></a>
            ...
            <li class="nav-item"><a class="nav-link" href="{{route('admin.track')}}"><i class="far fa-user-circle"></i><span>Track</span></a></li>
